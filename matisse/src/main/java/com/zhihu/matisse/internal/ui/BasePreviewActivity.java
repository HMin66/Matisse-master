...
public abstract class BasePreviewActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected LinearLayout mButtonBackLay;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mButtonBackLay = (LinearLayout) findViewById(R.id.button_back_lay);
        mPageNo = (TextView) findViewById(R.id.page_no);
        mButtonBack = (TextView) findViewById(R.id.button_back);
        mButtonApply = (TextView) findViewById(R.id.button_apply);
        mSize = (TextView) findViewById(R.id.size);
        mButtonBackLay.setOnClickListener(this);
...
//        Log.e("HMin66", mSpec.maxSelectable + " --- " + mSpec.maxImageSelectable);
        mPageNo.setText(mSelectedCollection.count() + "/" + mSelectedCollection.currentMaxSelectable());
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_back) {
            onBackPressed();
        } else if (v.getId() == R.id.button_back_lay) {
            onBackPressed();
